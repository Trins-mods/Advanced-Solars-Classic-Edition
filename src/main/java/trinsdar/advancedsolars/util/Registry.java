...
public class Registry {
    ...
    public static final BlockEntityType<TileEntityMolecularTransformer> MOLECULAR_TRANSFORMER_TYPE = IC2Tiles.createTile("molecular_transformer", TileEntityMolecularTransformer::new);
